...
DO BEGIN
    ...
    :header.insert(('Oid', 'My Classification Model'));
...
select * from
"SAP_PA_APL"."sap.pa.apl.debrief.report::BinaryTarget_Statistics"
(USER_APL.DEBRIEF_PROPERTY, USER_APL.DEBRIEF_METRIC);

select * from
"SAP_PA_APL"."sap.pa.apl.debrief.report::BinaryTarget_GroupCrossStatistics"
(USER_APL.DEBRIEF_PROPERTY, USER_APL.DEBRIEF_METRIC)
where "Partition" = 'Estimation' and "Variable" = 'AGE'
order by 1,2,3,4, to_char("Group");
